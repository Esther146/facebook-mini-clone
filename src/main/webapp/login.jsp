    ...
    <div class="item item2">
        ...
        <div class="loginForm">
            ...
            <form action="login" method="post">
                ...
                <input type="submit" value="Log in" id="loginBtn"><br><br>
            </form>
            <div class="forgotPassword">Forgotten password?</div>
            <a href=${pageContext.request.contextPath}/signup.jsp><input type="submit" value="Create New Account" id="anchorBtn"></a>
